...
export default function Header(){
 ...
 {/* Logo and Brand */}
   ...
   <img src="./icon/logo.svg" className="w-[28px] md:w-[50px]" alt="department of shipping" />
    ...
    <h2 className="text-black font-inter font-bold text-[16px] md:text-[20px] xl:text-[25px] 2xl:text-[30px]">
  ...
  {/* info */}
    <div className="flex jistify-between items-center gap-x-4  xl:gap-x-16 md:flex">
     <div className="hidden  gap-x-2   p-2 md:flex">
      ...
      <table className="table table-auto border-separate border-spacing-y-">
        ...
        <tr className="p-2 ">
          <td>
             <div className="flex text-black  font-inter text-sm font-normal leading-34 gap-x-2 xl:text-[15px]">Call</div>
          </td>
          <td className="px-1">: </td>
         <td>
         <div className="text-black  text-sm font-bold  leading-34 font-inter xl:text-[15px]"> 01576400104, 01576400105</div>
         </td>
           </tr>

           <tr className="p-2">
          <td>
             <div className="flex text-black  font-inter text-sm font-normal leading-34 lg:text-sm  gap-x-2 xl:text-[15px] ">Mail</div>
          </td>
          <td className="px-1">:</td>
         <td>
         <div className="text-black  text-sm font-bold  leading-34 font-inter lg:text-sm xl:  xl:text-[15px] "> dos.support@dream71.com</div>
         </td>
           </tr>
        </tbody>
      </table>
   ...
   <div className="flex items-center py-2 gap-2 md:gap-2 cursor-pointer">
     <p className="text-black text-center font-inter text-[9px] font-bold font-inter leading-normal md:text-xl xl:text-[15px]">Login</p>
     <img src="./icon/usericon.svg"  className ='w-[28px] md:w-[30px] xl:w-[50px] 2xl:w-[30px] 2xl:' alt="" />
     </div>
   </Link>
    </div>
