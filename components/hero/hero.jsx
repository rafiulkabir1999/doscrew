...
export default function Hero(){
    ...
    return(
        <div className=" bg-bg_image grid grid-row-1 p-16 obj-cover px-8  bg-cover bg-no-repeat bg-center items-center  xl:px-16  pt-16 gap-y-5 gap-x-8 gap-x-2 h-screen md:grid-cols-2 md:gap-x-8 md:h-[80vh] md:flex-row">
            <div className="flex flex-col gap-10 flex-.5 pt-40  md:pt-0 md:gap-5  ">
