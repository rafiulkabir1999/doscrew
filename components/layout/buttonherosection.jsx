...
export default function Buttonherosection (props) {
    return(
       <div>
        ...
        <div className={`${props.details.color}  p-0 py-2  flex items-center border-gray-400 border border-baseblue shrink-0 justify-between rounded border cursor-pointer   md:gap-0   rounded-md border border-blue-500 md:p-6 px-2 md:py-5 xl:p-5  hover:bg-green-200 `}>
