...
export default function Buttonherosection (props) {
    return(
       <div>
        ...
        <div className={`${props.details.color}  p-0 py-1  flex items-center border-gray-400 border border-[#0C63B4] justify-between rounded-[1.9px] cursor-pointer   md:gap-0   md:rounded-md  md:p-2 px-2 md:py lg:p-4 xl:p-6  hover:bg-green-200 `}>
